...
class FAQExpandableAdapter(val context : Context) : BaseExpandableListAdapter() {
    ...
    val bigList = listOf("공지 내용이 부정확해요. 오류 보고는 어떻게 하나요??", "시간표 테마/색상을 변경하고 싶어요","온라인 강의는 시간표에 추가할 수 없나요?",
    "삭제된 게시글/댓글을 복구하고 싶어요.", "개인정보 침해, 허위사실 유표, 명예 훼손 등에 법적인 조취를 치하고 싶어요.", "신고된 게시글/댓글은 어떻게 처리되나요?",
    ...
    "시간표 테마/색상을 변경하시려면, 대표 시간표에서 과목 블록을 길게 탭해주세요. 그 후 팝업 창에서 ‘시간표 커스터마이징’ 버튼을 눌러 시간표를 다양하게 꾸밀 수 있습니다.",
            "강의 시간이 확정되지 않은 온라인 강의의 경우, 시간표에 추가할 수 없습니다.", "유링크 게시판에서 삭제된 글과 댓글은 영구 폐기 처리되며, 복구할 수 없습니다.", "유링크는 정보통신망 이용촉진 및 정보보호 등에 관한 법률에 근거하여, 개인정보 침해, 허위사실 유포, 명예 훼손 등 개인의 권리 침해에 대한 게시글/댓글에 대한 신고를 받고 있습니다. 보다 강력한 법적 조치를 원하실 경우, 직접 수사기관에 의뢰하여 주시기 바랍니다. 유링크는 수사기관에서 유효하다고 판단한 법적 협조 요청에 대해 최대한의 노력을 다할 것임을 약속드립니다.",
    "신고된 게시글/댓글은 최초 신고가 접수되면 24간 이내 운영진 측에서 신고 사유를 검토 후, 부적절하다고 판단될 경우 삭제됩니다. 신고가 누적된 사용자의 경우 유링크 서비스 이용에 제한을 받을 수 있습니다.",
    ...
    "현재 유링크 서비스는 학교 이메일을 유일한 인증 수단으로 활용하고 있습니다. 학교 이메일 이외에 재학생/졸업생을 증명할 수 있는 다른 방법은 제공하지 않으며, 유링크 서비스 이용을 위해 대학 홈페이지에서 학교 이메일 찾기를 먼저 진행해주시기 바랍니다.",
